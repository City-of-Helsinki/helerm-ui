...
export default {
  ...
  SENTRY_TRACE_PROPAGATION_TARGETS: import.meta.env.SENTRY_TRACE_PROPAGATION_TARGETS,
  SENTRY_TRACES_SAMPLE_RATE: import.meta.env.SENTRY_TRACES_SAMPLE_RATE,
  SENTRY_REPLAYS_SESSION_SAMPLE_RATE: import.meta.env.SENTRY_REPLAYS_SESSION_SAMPLE_RATE,
  SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE: import.meta.env.ENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE,
